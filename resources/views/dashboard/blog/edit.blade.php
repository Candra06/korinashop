...
<form action="/dashboard/blog/index/{{$data->id}}" enctype="multipart/form-data" method="POST">
    @method('put')
    @csrf
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <input type="text" name="judul" value="{{$data->judul}}" class="form-control @error('judul') is-invalid @enderror" placeholder="judul">
                            @error('judul')
                        ...
                        <div class="col-lg-12 mb-3">
                            <textarea id="mymce" name="konten">{{$data->konten}}</textarea>
                            @error('konten')
